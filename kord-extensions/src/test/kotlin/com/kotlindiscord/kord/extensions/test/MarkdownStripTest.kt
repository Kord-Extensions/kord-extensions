...
import com.kotlindiscord.kord.extensions.utils.parseMarkdown
...
class MarkdownStripTest {
    ...
    fun `test escaping of italics`() {
        assertEquals("""italics""", strip("*italics*"), "Italics must be stripeed (*)")
        assertEquals("""italics""", strip("_italics_"), "Italics must be stripeed (_)")
    }
