...
public open class EphemeralStringSelectMenu<M : ModalForm>(
...
) : StringSelectMenu<EphemeralStringSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = EphemeralStringSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: EphemeralStringSelectMenuContext<M>,
        message: String,
