 ...
 * @property kord Kord instance
 * @property job Job running to listen to events
 * @property listening `true` if the manager listening the events, `false` otherwise
 * @property events List of events that will be apply according to the type of a event
 * @property stopAction Action to apply to the end of the listening
 */
public open class MessageEventManager(
    ...
    public companion object {
        private const val DEFAULT_TIME_LISTENING = 1000L * 60L * 5L
    }
