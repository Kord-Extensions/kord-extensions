...
public open class EphemeralUserSelectMenu<M : ModalForm>(
...
) : UserSelectMenu<EphemeralUserSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = EphemeralUserSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: EphemeralUserSelectMenuContext<M>,
        message: String,
