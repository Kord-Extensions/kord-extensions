...
public open class PublicRoleSelectMenu<M : ModalForm>(
...
) : RoleSelectMenu<PublicRoleSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = PublicRoleSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: PublicRoleSelectMenuContext<M>,
        message: String,
