...
public open class PublicUserSelectMenu<M : ModalForm>(
...
) : UserSelectMenu<PublicUserSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = PublicUserSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: PublicUserSelectMenuContext<M>,
        message: String,
