...
public open class EphemeralRoleSelectMenu<M : ModalForm>(
...
) : RoleSelectMenu<EphemeralRoleSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = EphemeralRoleSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: EphemeralRoleSelectMenuContext<M>,
        message: String,
