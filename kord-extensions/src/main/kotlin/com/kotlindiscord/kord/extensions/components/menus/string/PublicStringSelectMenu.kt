...
public open class PublicStringSelectMenu<M : ModalForm>(
...
) : StringSelectMenu<PublicStringSelectMenuContext<M>, M>(timeoutTask) {
    ...
    override suspend fun call(event: SelectMenuInteractionCreateEvent): Unit = withLock {
        ...
        val context = PublicStringSelectMenuContext(this, event, response, cache)
    ...
    override suspend fun respondText(
        context: PublicStringSelectMenuContext<M>,
        message: String,
