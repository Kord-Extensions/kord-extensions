...
/** Attempt to resolve the locale for the given [ApplicationCreateEvent] object. **/
@OptIn(KordPreview::class)
public suspend fun ApplicationCreateEvent.getLocale(): Locale {
    val existing = localeCache[this]
...
/** Attempt to resolve the locale for the given [ComponentCreateEvent] object. **/
@OptIn(KordPreview::class)
public suspend fun ComponentCreateEvent.getLocale(): Locale {
    val existing = localeCache[this]
