...
public class PublicMentionableSelectMenuContext<M : ModalForm>(
	override val component: PublicMentionableSelectMenu<M>,
...
) : MentionableSelectMenuContext(component, event, cache), PublicInteractionContext
